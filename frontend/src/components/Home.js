...
export const Home = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4">
            {/* Create Group Form */}
            <div className="mb-8">
                <form onSubmit={handleCreateGroup} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <h2 className="text-xl font-semibold mb-4 dark:text-white">Create New Group</h2>
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-grow px-3 py-2 border rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                        />
                        <button
                            type="submit"
                ...
                {groups.map((group) => (
                    ...
                    >
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <button
                                data-action="delete"
                                className="px-3 py-1 bg-red-100 text-red-700 rounded hover:bg-red-200 dark:bg-red-900 dark:text-red-300 dark:hover:bg-red-800"
                            >
                                Delete
                            </button>
                        </div>
